...
public static class GraphExtensions
{
    public static IRoute GetShortestRoute(this IGraph graph, Type origin, Type destination)
    {
        ...
        return graph.GetShortestRoute(origin, destination, Waypoints.Empty(), ExcludedNodes.Empty());
    }

    public static IRoute GetShortestRoute(this IGraph graph, Type origin, Type destination, IExcludedNodes excludedNodes)
    {
        ArgumentNullException.ThrowIfNull(graph, nameof(graph));
        return graph.GetShortestRoute(origin, destination, Waypoints.Empty(), excludedNodes);
    }

    public static IRoute GetShortestRoute(this IGraph graph, Type origin, Type destination, IWaypoints waypoints)
    {
        ArgumentNullException.ThrowIfNull(graph, nameof(graph));
